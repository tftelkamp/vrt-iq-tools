...
# VRT IQ tools
all: clients dt
clients: vrt_fftmax vrt_gnuplot vrt_to_sigmf sigmf_to_vrt vrt_forwarder vrt_spectrum vrt_to_void control_vrt vrt_to_rtl_tcp vrt_fftmax_quad vrt_to_filterbank vrt_to_fifo vrt_pulsar
...
vrt_to_sigmf: vrt_to_sigmf.cpp
		g++ -O3 $(INCLUDES) $(LIBS) $(CFLAGS) -o vrt_to_sigmf vrt_to_sigmf.cpp \
		-lvrt -lzmq $(BOOSTLIBS) -lpthread

vrt_to_gnuradio: vrt_to_gnuradio.cpp
		g++ -O3 $(INCLUDES) $(LIBS) $(CFLAGS) -o vrt_to_gnuradio vrt_to_gnuradio.cpp \
...
vrt_to_fifo: vrt_to_fifo.cpp
		g++ -O3 $(INCLUDES) $(LIBS) $(CFLAGS) -o vrt_to_fifo vrt_to_fifo.cpp \
		-lvrt -lzmq $(BOOSTLIBS)

vrt_to_vrt_quad: vrt_to_vrt_quad.cpp
		g++ -O3 $(INCLUDES) $(LIBS) $(CFLAGS) -o vrt_to_vrt_quad vrt_to_vrt_quad.cpp \
		-lvrt -lzmq $(BOOSTLIBS)

vrt_to_rtl_tcp: vrt_to_rtl_tcp.cpp
		g++ -O3 $(INCLUDES) $(LIBS) $(CFLAGS) -o vrt_to_rtl_tcp vrt_to_rtl_tcp.cpp \
		-lvrt -lzmq $(BOOSTLIBS)

vrt_fftmax: vrt_fftmax.cpp
		g++ -O3 $(INCLUDES) $(LIBS) $(CFLAGS) -o vrt_fftmax vrt_fftmax.cpp \
		-lvrt -lzmq $(BOOSTLIBS) -lpthread -lfftw3

vrt_pulsar: vrt_pulsar.cpp
		g++ -O3 $(INCLUDES) $(LIBS) $(CFLAGS) -o vrt_pulsar vrt_pulsar.cpp \
		-lvrt -lzmq $(BOOSTLIBS) -lpthread -lfftw3
...
vrt_gnuplot: vrt_gnuplot.cpp
		g++ -O3 $(INCLUDES) $(LIBS) $(CFLAGS) -o vrt_gnuplot vrt_gnuplot.cpp \
		-lvrt -lzmq $(BOOSTLIBS) -lpthread -lfftw3

vrt_spectrum: vrt_spectrum.cpp
		g++ -O3 $(INCLUDES) $(LIBS) $(CFLAGS) -o vrt_spectrum vrt_spectrum.cpp \
		-lvrt -lzmq $(BOOSTLIBS) -lpthread -lfftw3

vrt_forwarder: vrt_forwarder.cpp
		g++ -O3 $(INCLUDES) $(LIBS) $(CFLAGS) -o vrt_forwarder vrt_forwarder.cpp \
		-lzmq $(BOOSTLIBS)

rtlsdr_to_vrt: convenience.o rtlsdr_to_vrt.cpp
		g++ -O3 $(INCLUDES) $(LIBS) $(CFLAGS) convenience.o rtlsdr_to_vrt.cpp -o rtlsdr_to_vrt \
		$(BOOSTLIBS) -lzmq -lvrt -lrtlsdr

rfspace_to_vrt: rfspace_to_vrt.cpp
		g++ -O3 $(INCLUDES) $(LIBS) $(CFLAGS) rfspace_to_vrt.cpp -o rfspace_to_vrt \
		$(BOOSTLIBS) -lzmq -lvrt
...
sigmf_to_vrt: sigmf_to_vrt.cpp
		g++ -O3 $(INCLUDES) $(LIBS) $(CFLAGS) sigmf_to_vrt.cpp -o sigmf_to_vrt \
		$(BOOSTLIBS) -lzmq -lvrt

control_vrt: control_vrt.cpp
		g++ -O3 $(INCLUDES) $(LIBS) $(CFLAGS) control_vrt.cpp -o control_vrt \
		$(BOOSTLIBS) -lzmq -lvrt
...
vrt_to_dada: vrt_to_dada.cpp
		g++ -O3 $(INCLUDES) $(LIBS) $(CFLAGS) -o vrt_to_dada vrt_to_dada.cpp \
...
vrt_rffft: vrt_rffft.cpp
		g++ -O3 $(INCLUDES) $(LIBS) $(CFLAGS) vrt_rffft.cpp -o vrt_rffft \
